      ...
      error(function (data, status, headers, config) {
        ...
        $scope.TaoMoi = function (Ma, Ten, Gia, Hinh, MoTa, SoLuong, LSP, NSX, KhuyenMai, banchay, Moi) {
            if (Ten) {
                ...
                var data = { "MA": Ma, "TEN": Ten, "DONGIABAN": Gia, "HINHANH": Hinh, "MOTA": MoTa, "SOLUONG": SoLuong, "LOAISANPHAM": 3, "SANPHAMMOI": Moi, "NHASANXUAT": 1, "SANPHAMBANCHAY": banchay, "DAXOA": false, "MAKHUYENMAI": KhuyenMai, "TENLOAISANPHAM": LSP, "TENNHASANXUAT": NSX };
